                ...
                <div class="mb-md-5 mt-md-4 pb-5">
                  ...
                  <form action="{{ route('login_process') }}" method="post">
                    ...
                    <div class="form-outline form-white mb-4">
                      <input name="email" type="email" id="typeEmailX" class="form-control form-control-lg button-save" />
                      <label class="form-label" for="typeEmailX" style="color: white">Email</label>
                    </div>

                    <div class="form-outline form-white mb-4">
                      <input name="password" type="password" id="typePasswordX" class="form-control form-control-lg button-save" />
