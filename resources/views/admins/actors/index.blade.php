...
<div class="row">
  <div class="col-12">
    <div class="mb-3">
      <a href="{{ route('actors.create') }}" class="btn btn-success button-savet" data-toggle="modal" data-target="#exampleModal">Добавить</a>
    </div>
    <div class="card">
      ...
      <div class="table-responsive p-0">
        <table class="table table-hover text-nowrap table-borderless table-striped">
          ...
          <tbody class="actors-list">
            ...
            <tr>
              <th><a href="#" data-toggle="modal" data-target="#myModal{{ $actor->id }}">{{ $actor->name }}</a>
