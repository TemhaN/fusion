              ...
              <div class="controls">
                  ...
                  <div class="col">
                    <div class="form-group">
                      ...
                      <input type="text" class="@error('name') is-invalid @enderror form-control" id="name"
                        name="name" value="{{ old('name', isset($film) ? $film->name : '') }}">
                      @error('name')
                  ...
                  <div class="col">
                    <div class="form-group">
                      ...
                      <input type="namber" class="@error('duration') is-invalid @enderror form-control" id="duration"
                        name="duration" value="{{ old('duration', isset($film) ? $film->duration : '') }}">
                      @error('duration')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                ...
                <div class="row">
                  <div class="col">
                    <div class="form-group">
                      ...
                      <input type="namber" class="@error('age') is-invalid @enderror form-control" id="age"
                        name="age" value="{{ old('age', isset($film) ? $film->age : '') }}">
                      @error('age')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="text" class="@error('link_img') is-invalid @enderror form-control" id="link_img"
                          name="link_img" value="{{ old('link_img', isset($film) ? $film->link_img : '') }}">
                      </div>
                      @error('link_imge')
                        <div class="invalid-feedback">
                          {{ $message }}
                  ...
                  <div class="col">
                    <div class="form-group">
                      ...
                      <input type="text" class="@error('link_video') is-invalid @enderror form-control" id="link_video"
                        name="link_video" value="{{ old('link_video', isset($film) ? $film->link_video : '') }}">
                      @error('link_video')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                  ...
                  <div class="col">
                    ...
                    <div class="my-4">
                      <img src="{{ old('link_img', isset($film) ? $film->link_img : '') }}" alt="Постер"
                        class="img-film-createblade" id="poster-preview">
                    </div>
                  </div>
                </div>
              </div>
