        ...
        <div class="modal-body">
          <form action="{{ route('users.store') }}" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" class="@error('fio') is-invalid @enderror form-control" id="fio" name="fio"
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="{{ route('users.update', $user->id) }}" method="POST">
                              ...
                              <div class="form-group">
                                <label for="fio">ФИО</label>
                                <input type="text" class="@error('fio') is-invalid @enderror form-control"
                                  id="fio" name="fio"
                                  value="{{ old('fio', isset($user) ? $user->fio : '') }}">
                                @error('fio')
                                  <div class="invalid-feedback">
      ...
      search.addEventListener('keyup', function() {
        ...
        for (let i = 0; i < users.length; i++) {
          ...
          let match = queries.every(function(q) {
            return fio.toLowerCase().includes(q) || gender.toLowerCase().includes(q) || email.toLowerCase()
              .includes(q);
          });
